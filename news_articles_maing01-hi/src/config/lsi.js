const Lsi = {
  appName: {
    cs: "Aplikace newsArticles",
    en: "Application newsArticles",
  },
  ...
  about: {
    header: {
      cs: "O aplikaci newsArticles",
      en: "About application newsArticles",
    },
    creatorsHeader: {
      cs: "Tvůrci aplikace",
  ...
  unauthInit: {
    buyYourOwn: {
      cs: "Můžete si koupit vlastní newsArticles.",
      en: "You can buy your own newsArticles.",
    },
    notAuthorized: {
      cs: "Nemáte právo inicializovat tuto aplikaci newsArticles.",
      en: "You don't have rights to initialize this newsArticles.",
    },
  },
