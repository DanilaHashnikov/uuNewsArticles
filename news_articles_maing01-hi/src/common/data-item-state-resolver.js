...
export const DataItemStateResolver = createComponent({
  //@@viewOn:statics
  displayName: Config.TAG + "DataItemStateResolver",
  //@@viewOff:statics

  //@@viewOn:propTypes
  propTypes: {
    dataItem: UU5.PropTypes.object,
  ...
  render(props) {
    ...
    switch (props.dataItem.state) {
      ...
      case "errorNoData": {
        child = <DataError height={props.height} moreInfo errorData={props.dataItem.errorData} />;
        break;
      }
      case "pendingNoData": {
...
export default DataItemStateResolver;
